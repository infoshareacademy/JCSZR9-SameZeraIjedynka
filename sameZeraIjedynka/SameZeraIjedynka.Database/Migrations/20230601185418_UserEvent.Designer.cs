...
namespace SameZeraIjedynka.Database.Migrations
{
    ...
    [Migration("20230601185418_UserEvent")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventUser", b =>
                {
                    b.Property<int>("UsersEventsEventId")
                        .HasColumnType("int");

                    b.Property<int>("UsersUserId")
                        .HasColumnType("int");

                    b.HasKey("UsersEventsEventId", "UsersUserId");
            ...
            modelBuilder.Entity("EventUser", b =>
                {
                    b.HasOne("SameZeraIjedynka.Database.Entities.Event", null)
                        .WithMany()
                        .HasForeignKey("UsersEventsEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SameZeraIjedynka.Database.Entities.User", null)
                        .WithMany()
